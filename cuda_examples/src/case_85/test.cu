...
for (int i=0; i < var_1; ++i) {
  if (comp >= var_2 * (+1.5519E-37f / var_3 + var_4)) {
    comp += -1.2889E34f / (var_5 + -1.7763E35f);
comp += coshf(var_6 - (var_7 - +1.5491E26f * +1.7324E-23f - -1.8060E-36f + var_8));
comp += var_9 * asinf(-1.4719E-35f / (-0.0f - (+1.8989E-26f / (var_10 * (var_11 - var_12)))));
comp += (+1.7272E-35f * +1.7910E-36f * var_13 / (var_14 * var_15));
}
}
   printf("%.17g\n", comp);
