...
float tmp_1 = powf(-1.4943E-18f + +1.8677E-35f, (var_2 * var_3 + -1.7708E-37f));
comp += tmp_1 / sinf((var_4 / var_5));
comp = var_6 * var_7 - (var_8 * -0.0f);
for (int i=0; i < var_1; ++i) {
  comp = fmodf((-1.5096E-13f * ceilf((-1.6839E-20f + (+0.0f * -1.0239E-41f + (var_9 + (var_10 + var_11)))))), (-1.1500E-41f - var_12));
}
   printf("%.17g\n", comp);
