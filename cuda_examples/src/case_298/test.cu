...
if (comp == (-0.0f - ldexpf(var_2 - (-1.5269E35f * var_3), 2))) {
  comp += -1.8053E0f * var_4 * -0.0f / -1.8291E35f;
for (int i=0; i < var_1; ++i) {
  comp = fmodf(+1.5648E-37f * (-1.4791E-37f / (+1.8672E34f + (-1.4308E36f - +1.8486E-36f))), var_5 + +0.0f);
comp = var_6 * var_7 - ldexpf(+1.4046E-41f, 2);
}
if (comp < var_8 * var_9 + (var_10 / var_11)) {
  comp += +1.2062E-36f * (+1.1615E-36f * -1.6866E-8f / var_12 - (-1.5701E16f - var_13));
}
if (comp <= var_14 + var_15 / (var_16 - -1.9326E-36f)) {
  comp += (+1.5622E-6f - (var_17 * var_18 + (var_19 + fmodf((var_20 * -1.5086E34f / atan2f(coshf((var_21 * ceilf(var_22 * +1.3922E-26f))), (var_23 + (-0.0f * (var_24 / (+1.5309E36f - var_25)))))), var_26 * (var_27 - var_28)))));
comp = (var_29 + var_30);
}
}
   printf("%.17g\n", comp);
