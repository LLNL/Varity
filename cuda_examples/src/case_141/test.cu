...
if (comp >= (var_3 * (var_4 * var_5))) {
  comp = (-1.0980E-35f - sinhf((-0.0f + var_6 / var_7)));
comp += (var_8 - +1.3014E-44f);
for (int i=0; i < var_1; ++i) {
  comp = (-1.4811E-37f + -1.2673E4f);
}
for (int i=0; i < var_2; ++i) {
  float tmp_1 = atanf(var_9 + (var_10 * var_11));
float tmp_2 = (+1.0189E34f * var_12 / +1.7061E-41f);
comp += tmp_2 / tmp_1 + (var_13 + -1.3940E-3f);
}
}
   printf("%.17g\n", comp);
