...
comp = -1.7988E-43f - -0.0f / -1.8816E-41f - var_2;
comp += +0.0f * var_3 + var_4 * var_5;
for (int i=0; i < var_1; ++i) {
  comp = log10f((var_6 * var_7 * (-1.8613E-41f + fabsf(var_8 / (+1.9780E-41f + (+0.0f - var_9))))));
}
if (comp == (-0.0f * -1.9514E-41f - -0.0f + coshf(-1.8413E-37f))) {
  comp += var_10 * var_11;
comp += (var_12 + (+0.0f / var_13 - powf(atanf(+1.3152E35f * +1.7788E34f + (var_14 / (+1.7141E-41f - floorf((var_15 * -1.3083E34f))))), -1.2306E26f)));
float tmp_1 = expf(-1.0306E35f);
comp = tmp_1 / acosf(cosf(var_16 / var_17 / (var_18 - (var_19 - (var_20 - var_21)))));
}
   printf("%.17g\n", comp);
