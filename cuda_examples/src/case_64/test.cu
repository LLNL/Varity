...
if (comp == powf((var_2 * -1.0609E-37f * (var_3 - var_4)), floorf((var_5 + +1.3710E-36f - (+0.0f - var_6 - -1.2011E-37f))))) {
  for (int i=0; i < var_1; ++i) {
    comp += (var_7 + var_8 + (var_9 - log10f((var_10 + var_11))));
if (comp <= var_12 + var_13 * sqrtf(-1.2972E34f)) {
  float tmp_1 = (var_14 - (var_15 * (-1.6391E-37f * var_16 / var_17)));
comp = tmp_1 - (+1.2982E-42f + (+1.2551E36f - var_18));
float tmp_2 = -1.7698E35f;
comp += tmp_2 + (+1.4354E34f - (-1.6986E-41f - (-1.8569E-37f - (+1.3390E-36f * (var_19 * var_20)))));
}
}
}
   printf("%.17g\n", comp);
