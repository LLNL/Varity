...
if (comp <= var_1 + (var_2 + -1.7823E-13f)) {
  if (comp == var_3 * -1.1541E34f) {
    comp += var_4 - (var_5 - var_6);
float tmp_1 = (-1.1600E-16f - (var_7 + (var_8 + (-1.2462E-42f + sqrtf(+1.0498E-37f)))));
comp = tmp_1 * var_9 + (var_10 * var_11);
}
}
   printf("%.17g\n", comp);
