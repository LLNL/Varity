...
if (comp <= (var_2 / (var_3 / (var_4 / expf((var_5 * +1.5590E-42f + var_6 - var_7 + var_8)))))) {
  float tmp_1 = +1.0487E-37f;
comp += tmp_1 + var_9 + (+0.0f * -1.7790E-37f * +1.9295E35f);
if (comp == (var_10 / (var_11 / var_12))) {
  float tmp_2 = +1.5016E-37f + +1.9593E36f - cosf(var_13 / sqrtf(ldexpf(+1.4346E36f - +1.5960E-1f * log10f((var_14 - (-1.6971E16f + -1.6058E34f * +1.6657E-41f / -1.8462E-41f))), 2)));
comp += tmp_2 * atanf(var_15 - +1.7443E-37f);
}
if (comp <= (var_16 + var_17 - var_18)) {
  comp = cosf(+1.5876E-36f);
comp += (var_19 / -1.7643E34f + (var_20 * (-1.5648E-5f / (-0.0f * -1.4400E8f))));
comp = +1.5809E-28f * var_21 * asinf(cosf(var_22 - (var_23 / cosf(ceilf((var_24 * (var_25 * var_26)))))));
}
for (int i=0; i < var_1; ++i) {
  comp += (var_27 - var_28 * -1.4482E12f);
}
}
   printf("%.17g\n", comp);
