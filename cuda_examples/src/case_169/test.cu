...
float tmp_1 = +1.9087E-37f;
comp += tmp_1 * var_2 * atan2f(var_3 - +1.9122E-6f * var_4 * (-0.0f / var_5), ceilf((+0.0f - -1.0134E-37f - -1.1554E-42f * var_6)));
comp = +0.0f - -1.6493E-42f + (+1.0428E-30f - var_7);
for (int i=0; i < var_1; ++i) {
  comp += (var_8 - var_9);
comp += logf(+1.5001E-35f - var_10 / var_11 * var_12 + var_13);
comp = atan2f(expf(+0.0f - -1.5600E-22f), -1.0130E36f / +0.0f / (var_14 + -1.2549E-43f));
}
   printf("%.17g\n", comp);
