...
if (comp > -1.9157E-41f + ceilf((+1.5242E-36f - var_1 - var_2 + -1.3343E11f))) {
  float tmp_1 = -1.0025E-20f;
comp += tmp_1 * acosf((var_4 - var_5 / (var_6 / var_7)));
comp += (var_8 / (var_9 - (-1.2082E-1f - -1.2852E-42f)));
for (int i=0; i < var_3; ++i) {
  comp = var_10 - -1.7545E-44f;
comp = acosf((var_11 * -1.7718E-41f * +1.5120E36f / var_12));
comp = (var_13 - (-1.3659E13f / var_14 / fmodf(var_15 + -1.1530E-41f + +1.4933E-6f, (var_16 * var_17 * +1.0793E-43f - var_18))));
comp = expf(-1.4044E-37f);
}
if (comp <= atan2f((var_19 / var_20 * (-1.8581E-42f + (var_21 + var_22 + var_23))), log10f((-0.0f / var_24 / (var_25 + var_26 + sqrtf(+1.2291E23f)))))) {
  comp += (var_27 + (var_28 * var_29));
comp = -1.3685E36f * acosf(cosf((-1.0995E-41f / +1.4802E17f)));
comp = -1.5914E36f - +1.2207E-29f;
}
}
   printf("%.17g\n", comp);
