...
float tmp_1 = +1.7323E34f / -0.0f - (-0.0f - (var_1 * var_2 - -1.0836E-43f));
float tmp_2 = +1.6214E-42f;
comp += tmp_2 / tmp_1 + (var_3 + fabsf(+1.0408E5f));
comp = coshf((var_4 / (var_5 * var_6 * (+1.2497E22f * (var_7 * var_8)))));
   printf("%.17g\n", comp);
