...
comp = tanhf(+1.1628E-2f * (+1.5568E-44f + (+1.1378E-37f + -1.4730E36f)));
if (comp < ldexpf(var_1 - var_2 + (var_3 - -1.5236E-37f), 2)) {
  comp += powf(+1.7258E-24f, (var_4 + (var_5 - logf(var_6 * var_7 + var_8 + +1.6398E-36f))));
}
   printf("%.17g\n", comp);
