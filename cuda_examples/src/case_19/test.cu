...
if (comp > coshf(var_1 + var_2 - var_3)) {
  if (comp >= (-1.0293E34f - -1.5723E36f + var_4 + var_5 + var_6)) {
    comp += fabsf((+0.0f / (var_7 / (+1.8013E-43f / -1.9809E36f))));
comp = (var_8 - var_9 - +1.4245E36f + var_10 * (var_11 / +1.1140E-43f));
float tmp_1 = -1.3743E34f;
comp += tmp_1 - var_12 + (var_13 + (var_14 * var_15));
}
}
   printf("%.17g\n", comp);
