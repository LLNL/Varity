...
if (comp <= var_1 + var_2) {
  comp += var_3 / var_4 / (var_5 / (-1.1792E-37f / var_6));
comp += (+1.3977E-11f + -0.0f * sinf((var_7 / fmodf(var_8 + -1.5220E-37f, var_9 / (var_10 * (var_11 + fmodf(-1.9661E34f, var_12 * (var_13 - +1.9923E-41f - (var_14 - +1.2731E35f)))))))));
comp += var_15 * (+1.5998E-44f - -1.3708E-44f);
}
   printf("%.17g\n", comp);
