...
for (int i=0; i < var_1; ++i) {
  comp = (var_2 * +1.5271E-42f * (var_3 / floorf(-1.5532E35f - +1.8528E35f - (var_4 * (-1.4807E36f - +0.0f)))));
comp = var_5 + +1.1129E35f + var_6 / powf(expf(+1.4350E-36f), -0.0f + (var_7 / -1.7503E11f * var_8 / +1.5272E-19f));
}
   printf("%.17g\n", comp);
