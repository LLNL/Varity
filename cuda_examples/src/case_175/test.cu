...
comp = (var_1 / var_2 * var_3 / sinf(var_4 - +1.0653E-42f * (var_5 * var_6)));
float tmp_1 = +1.0996E-13f;
float tmp_2 = log10f(var_7 - var_8 / var_9 - +1.0304E-42f);
comp += tmp_2 - tmp_1 * (-1.6914E-43f - (var_10 + (var_11 + (var_12 + -0.0f))));
   printf("%.17g\n", comp);
