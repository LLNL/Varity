...
if (comp <= +1.5072E36f + (var_1 + (var_2 / asinf((-1.8411E-43f / (-1.9566E-35f * var_3 / (var_4 - -0.0f - var_5))))))) {
  if (comp <= var_6 * -1.5579E-22f + tanhf(+1.2932E3f)) {
    comp = tanhf(var_7 / +1.7279E-35f / (-1.8810E36f - var_8 / var_9 * -1.3163E-4f));
}
}
   printf("%.17g\n", comp);
