...
if (comp == (var_3 * var_4)) {
  for (int i=0; i < var_1; ++i) {
    for (int i=0; i < var_2; ++i) {
      comp = var_5 * floorf(-1.5516E36f);
comp = (-1.9329E1f - (-0.0f + -1.9550E36f - var_6 + (var_7 / var_8)));
comp = var_9 / (+1.4778E36f - (var_10 / var_11));
if (comp >= (var_12 / -0.0f)) {
  float tmp_1 = +1.6003E36f;
comp += tmp_1 * (-1.3393E36f / var_13);
}
}
}
}
