...
if (comp < var_2 * (+1.2787E-43f * var_3 * (var_4 + asinf(var_5 - var_6 * var_7 - var_8)))) {
  for (int i=0; i < var_1; ++i) {
    comp = (+1.6971E-41f / (var_9 / fabsf(sinhf((+0.0f * atan2f((var_10 / -1.2939E-44f), -1.1731E35f))))));
comp += (+1.4209E36f - var_11 + (var_12 * +1.0037E-37f));
if (comp <= acosf(+0.0f)) {
  float tmp_1 = +1.6996E-37f;
comp += tmp_1 + var_13 + +1.2858E-10f;
comp = +1.7035E-2f - var_14;
comp += var_15 - (var_16 - (+1.6324E-36f / -1.3862E18f));
}
}
}
   printf("%.17g\n", comp);
