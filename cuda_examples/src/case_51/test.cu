...
for (int i=0; i < var_1; ++i) {
  comp = var_2 * (-1.3244E36f - var_3 + +1.2920E36f);
float tmp_1 = var_4 - var_5 * var_6;
comp = tmp_1 - -0.0f * +0.0f * -1.3516E-43f;
if (comp >= (var_7 + var_8 - tanhf((var_9 / (+1.1018E36f * (+1.8430E36f + +1.6856E34f)))))) {
  comp += acosf((var_10 * (var_11 - ldexpf(var_12 * (var_13 / -1.0832E10f - var_14), 2))));
float tmp_2 = -0.0f;
comp = tmp_2 - (var_15 + +1.1307E-42f * (var_16 + fmodf(var_17 + atanf(sinhf((var_18 - -1.1517E-37f / atan2f(-1.8864E-35f, (var_19 - (var_20 / +1.8405E-37f)))))), fabsf(+1.7777E-35f))));
comp += +1.4643E-36f / var_21 / +1.2877E-42f + var_22 / -1.1796E-36f - +1.6491E-36f;
}
}
   printf("%.17g\n", comp);
