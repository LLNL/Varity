...
comp = var_2 - sinhf((-1.0704E-35f / (var_3 - var_4)));
float tmp_1 = (var_5 - var_6);
comp = tmp_1 - -1.0138E-43f / (var_7 - -1.4411E36f * -1.5918E36f * -1.1523E-18f);
for (int i=0; i < var_1; ++i) {
  var_8[i] = -1.2572E12f;
float tmp_2 = var_10 - ceilf(-1.1408E15f);
var_9[i] = var_11 + (+1.2625E-42f - -1.5289E35f);
comp += var_9[i] / tmp_2 - var_8[i] / (var_12 - var_13 * (var_14 + +1.7477E-41f / atan2f((var_15 + atanf((+1.7147E0f + +1.7054E27f - (+0.0f - (var_16 + var_17 - var_18))))), -1.6021E35f * (var_19 - -1.3869E-25f - expf((var_20 - (+0.0f - var_21 - var_22)))))));
}
   printf("%.17g\n", comp);
