...
float tmp_1 = (-0.0f + var_1 * -1.7939E19f);
comp += tmp_1 - (-1.5090E-36f + (+1.3658E36f / var_2 / (-1.5569E-43f * -1.9253E35f / var_3)));
comp = fmodf((var_4 * var_5 + (var_6 + (var_7 / var_8))), +1.4386E-44f);
comp += (var_9 * (var_10 - +0.0f));
   printf("%.17g\n", comp);
