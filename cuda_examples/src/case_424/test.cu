...
if (comp < (var_1 / (-1.2389E-44f / asinf(var_2 / +1.4917E35f + var_3 * (var_4 - (var_5 - +1.2951E-43f)))))) {
  float tmp_1 = -1.5543E-35f;
float tmp_2 = var_6 - var_7 + atanf((+1.9958E7f / var_8 / (var_9 + -1.8601E-44f - -1.0522E-37f)));
comp = tmp_2 * tmp_1 - (var_10 + var_11 / sqrtf((var_12 / (var_13 / var_14))));
}
   printf("%.17g\n", comp);
