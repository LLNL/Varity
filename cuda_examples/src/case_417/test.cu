...
if (comp >= (var_3 - fmodf(var_4 + (+1.4717E35f + atan2f((var_5 / var_6), (+1.4276E36f + +1.0317E-44f))), (var_7 / var_8 * -0.0f)))) {
  for (int i=0; i < var_1; ++i) {
    for (int i=0; i < var_2; ++i) {
      comp += (-0.0f / (var_11 / var_12));
for (int i=0; i < var_9; ++i) {
  float tmp_1 = var_13 + (var_14 - -1.6940E-8f + var_15 / acosf((-1.2253E34f / var_16 / var_17)));
comp += tmp_1 * atan2f((var_18 - (var_19 * var_20 - sinhf((-1.1729E24f * var_21)))), sinf(+1.7028E-43f / var_22 * (var_23 + -1.2731E-26f * var_24)));
}
