...
for (int i=0; i < var_1; ++i) {
  if (comp >= (-1.8968E36f - var_2 / (var_3 - (-1.6901E-36f + +1.8073E-44f)))) {
    if (comp > var_4 - var_5 - -1.1982E-36f) {
      float tmp_1 = (var_6 + (var_7 / (+1.4493E34f * var_8)));
comp += tmp_1 - (-0.0f * (-1.4937E-7f * var_9));
comp = var_10 - +0.0f;
if (comp == (var_11 + powf((var_12 + ldexpf(var_13 + (var_14 + (var_15 + var_16)), 2)), atanf(floorf(-0.0f))))) {
  comp = +0.0f + (var_17 + var_18 + +1.4742E-37f);
}
}
}
}
