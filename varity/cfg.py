...
#COMPILERS = [("gcc_8_3", "/usr/tce/packages/gcc/gcc-8.3.1/bin/gcc"), ("nvcc_10_1", "/usr/tce/packages/cuda/cuda-10.1.243/bin/nvcc")]
COMPILERS = [("nvcc_10_1", "/usr/tce/packages/cuda/cuda-10.1.243/bin/nvcc")]

# Levels of optimization to try
#OPT_LEVELS = [("-O0", 1), ("-O0", 0), ("-O1", 0), ("-O2", 0), ("-O3", 0)]
OPT_LEVELS = [("-O2", 0), ("-O3", 0)]
#OPT_LEVELS = ["-O0", "-O1"]
